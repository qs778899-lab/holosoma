...
从工程角度看，这一框架本质上是在“动作还原度”和“机器人可执行性”之间做动态平衡：当源动作包含超出机器人能力的姿态时，硬约束优先保证安全与可行，软约束则尽量保留交互结构不被破坏。因此，重定向结果与其说是对人类动作的逐帧复制，不如说是在物理可行空间内对交互意图的最优近似；调参时也通常先确保约束稳定满足，再逐步提高几何项权重以提升动作保真度。
