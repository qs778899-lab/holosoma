...
from holosoma_retargeting.src.interaction_mesh_retargeter_0128 import (  # noqa: E402
...
def find_files(data_dir: Path, data_format: str, object_name: str | None = None):
    ...
    Args:
        ...
        data_format: Data format ("lafan", "sik_bvh", "smplh", "mocap")
    ...
    if data_format in ["lafan", "sik_bvh", "nokov"]:
        # LAFAN/SIK_BVH/NOKOV: .npy files in root directory
